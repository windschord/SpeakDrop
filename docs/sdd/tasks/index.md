...
|---------|------|--------|--------|----------|-----------|
| Phase 1: 基盤構築 | 0 | 0 | 1 | 0 | [詳細](phase-1/) @phase-1/ |
| Phase 2: コアモジュール（TDD） | 0 | 0 | 8 | 0 | [詳細](phase-2/) @phase-2/ |
...
|----------|---------|-----------|------|------|-----------|
| TASK-001 | プロジェクトセットアップ | `IN_PROGRESS` | - | 20min | [詳細](phase-1/TASK-001.md) @phase-1/TASK-001.md |

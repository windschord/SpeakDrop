...
| TASK-011 | エントリーポイント（__main__.py） | `DONE` | TASK-010 | 10min | [詳細](phase-3/TASK-011.md) @phase-3/TASK-011.md |
...
| タスクID | タイトル | ステータス | 依存 | 見積 | 詳細リンク |
|----------|---------|-----------|------|------|-----------|
| TASK-012 | 結合テスト・品質チェック | `IN_PROGRESS` | TASK-002〜011 | 40min | [詳細](phase-4/TASK-012.md) @phase-4/TASK-012.md |
